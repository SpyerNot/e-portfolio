...
with col13:
    st.image("cert/junehack.png",caption="BuildingBloCS June Conference Hackathon 2024",width=250)
with col14:
    st.image("cert/top2024.jpg",caption="Top in Computing 2024 (Sec 3)",width=250)
