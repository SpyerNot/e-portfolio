...
with col9:
    st.image("cert/dic2024.jpg",caption="S1 Design Innovation Challenge 2024 2nd prize (Sec 3)",width=150)
...
with col13:
    st.image("cert/junehack.png",caption="BuildingBloCS June Conference Hackathon 2024",width=225)
with col14:
    st.image("cert/top2024.jpg",caption="Top in Computing 2024 (Sec 3)",width=225)
