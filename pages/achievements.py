...
with col2:
    st.image("cert/emb12023.jpg",caption="Edusave Merit Bursary Sec 2")
with col3:
    st.image("cert/eagles2023.jpg",caption="Edusave Award for Achievement, Good Leadership and Service Sec 2")
